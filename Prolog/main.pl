...
validar_disponibilidade(_, _, _) :-
    writeln('Inválido: professor indisponível.'),
    fail.
...
validar_professor_livre(_, _, _) :-
    writeln('Inválido: horário já ocupado.'),
    fail.
...
validar_aluno_livre(_, _, _) :-
    writeln('Inválido: aluno já possui atendimento.'),
    fail.
...
validar_limite_semanal(_) :-
    writeln('Inválido: limite semanal atingido.'),
    fail.
...
validar_disciplina(_, _) :-
    writeln('Inválido: disciplina incompatível.'),
    fail.
